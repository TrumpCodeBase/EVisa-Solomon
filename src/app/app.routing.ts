...
export const rootRouterConfig: Routes = [
  {
    path: "",
    redirectTo: "sessions/main-signin",
    pathMatch: "full"
  },
  {
    path: "home",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import("./views/application-list/application-list.module").then(
            m => m.ApplicationListModule
          ),
        data: { title: "Application List", breadcrumb: "Application List" }
      },
      {
        path: "dashboard",
        loadChildren: () =>
      ...
      },
      {
        path: "tour",
        loadChildren: () =>
          import("./views/app-tour/app-tour.module").then(m => m.AppTourModule),
